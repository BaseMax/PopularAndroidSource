...
final class VideoDownloadNotification$downloadingTapIntent$2 extends Lambda implements a<PendingIntent> {
    public final /* synthetic */ f this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public VideoDownloadNotification$downloadingTapIntent$2(f fVar) {
        super(0);
        this.this$0 = fVar;
    }
    ...
    public final PendingIntent invoke() {
        ...
        return PendingIntent.getBroadcast(this.this$0.f4669e, NotificationType.VIDEO_DOWNLOAD_COMPLETE.f(), intent, 134217728);
    }
}
