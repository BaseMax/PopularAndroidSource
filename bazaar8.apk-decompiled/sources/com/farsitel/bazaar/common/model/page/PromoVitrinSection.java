...
public class PromoVitrinSection implements AbstractSectionRowData<PromoItem>, RecyclerData {
    ...
    public PromoVitrinSection(List<PromoItem> list, String str, String str2, String str3, String str4, int i2) {
        j.b(list, "apps");
        j.b(str, "_title");
        j.b(str4, "referrer");
        this.apps = list;
    ...
    public /* synthetic */ PromoVitrinSection(List list, String str, String str2, String str3, String str4, int i2, int i3, f fVar) {
