...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class a extends ViewGroup.MarginLayoutParams {
        ...
        public a(Context context, AttributeSet attributeSet) {
            ...
            this.f425a = obtainStyledAttributes.getFloat(j.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.f426b = obtainStyledAttributes.getInt(j.LinearLayoutCompat_Layout_android_layout_gravity, -1);
        ...
        for (int i6 = 0; i6 < virtualChildCount; i6++) {
            ...
            if (!(a3 == null || a3.getVisibility() == 8 || !b(i6))) {
                ...
                if (a2) {
                    ...
                    i5 = (a3.getLeft() - aVar.leftMargin) - this.f424l;
                }
                b(canvas, i5);
            }
        }
    ...
    public int getBaseline() {
        ...
        if (childCount > i2) {
            ...
            if (baseline != -1) {
                int i3 = this.f415c;
                if (this.f416d == 1) {
                    int i4 = this.f417e & 112;
                    if (i4 != 48) {
                        if (i4 == 16) {
                            i3 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f418f) / 2;
                        } else if (i4 == 80) {
                            i3 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f418f;
                        }
                    }
                }
                return i3 + ((a) childAt.getLayoutParams()).topMargin + baseline;
            } else if (this.f414b == 0) {
                return -1;
            } else {
    ...
    public void setDividerDrawable(Drawable drawable) {
        if (drawable != this.f423k) {
            this.f423k = drawable;
            boolean z = false;
            if (drawable != null) {
                this.f424l = drawable.getIntrinsicWidth();
    ...
    public void setVerticalGravity(int i2) {
        ...
        int i4 = this.f417e;
        if ((i4 & 112) != i3) {
            this.f417e = i3 | (i4 & -113);
            requestLayout();
        }
    }

    public void setWeightSum(float f2) {
        this.f419g = Math.max(0.0f, f2);
    }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f415c = 0;
        this.f417e = 8388659;
        pa a2 = pa.a(context, attributeSet, j.LinearLayoutCompat, i2, 0);
        ...
        this.f419g = a2.b(j.LinearLayoutCompat_android_weightSum, -1.0f);
        this.f414b = a2.d(j.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.f420h = a2.a(j.LinearLayoutCompat_measureWithLargestChild, false);
    ...
    public void b(Canvas canvas, int i2) {
        this.f423k.setBounds(i2, getPaddingTop() + this.o, this.f424l + i2, (getHeight() - getPaddingBottom()) - this.o);
        this.f423k.draw(canvas);
    }

    public void a(Canvas canvas, int i2) {
        this.f423k.setBounds(getPaddingLeft() + this.o, i2, (getWidth() - getPaddingRight()) - this.o, this.m + i2);
        this.f423k.draw(canvas);
    }
    ...
    public void b(int i2, int i3, int i4, int i5) {
        ...
        int i13 = i11 & 8388615;
        if (i12 == 16) {
            i6 = getPaddingTop() + (((i5 - i3) - this.f418f) / 2);
        } else if (i12 != 80) {
            i6 = getPaddingTop();
        } else {
            i6 = ((getPaddingTop() + i5) - i3) - this.f418f;
        }
        int i14 = 0;
        while (i14 < virtualChildCount) {
            ...
            if (a2 == null) {
                ...
                int a3 = C0260c.a(i15, z.m(this)) & 7;
                if (a3 == 1) {
    ...
    public void a(int r25, int r26, int r27, int r28) {
        /*
            ...
            boolean r12 = r6.f413a
            int[] r13 = r6.f421i
            int[] r14 = r6.f422j
            int r1 = b.i.k.z.m(r24)
            int r1 = b.i.k.C0260c.a(r2, r1)
            r15 = 2
            r5 = 1
