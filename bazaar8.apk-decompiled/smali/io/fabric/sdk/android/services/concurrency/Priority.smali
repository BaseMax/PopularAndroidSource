...
.field public static final synthetic a:[Lio/fabric/sdk/android/services/concurrency/Priority;
...
.method public static a(Le/a/a/a/a/c/m;Ljava/lang/Object;)I
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<Y:",
    ...
    .line 1
    instance-of v0, p1, Le/a/a/a/a/c/m;

    if-eqz v0, :cond_0

    .line 2
    check-cast p1, Le/a/a/a/a/c/m;

    invoke-interface {p1}, Le/a/a/a/a/c/m;->getPriority()Lio/fabric/sdk/android/services/concurrency/Priority;
    ...
    invoke-interface {p0}, Le/a/a/a/a/c/m;->getPriority()Lio/fabric/sdk/android/services/concurrency/Priority;
