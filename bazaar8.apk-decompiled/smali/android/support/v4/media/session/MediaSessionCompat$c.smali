...
.method public a(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 6
    sget-boolean v0, Landroid/support/v4/media/session/MediaSessionCompat$c;->H:Z
    ...
    .line 9
    sput-boolean v0, Landroid/support/v4/media/session/MediaSessionCompat$c;->H:Z
...
.method public a(Landroid/support/v4/media/session/MediaSessionCompat$a;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$g;->a(Landroid/support/v4/media/session/MediaSessionCompat$a;Landroid/os/Handler;)V
    ...
    .line 3
    :cond_0
    new-instance p1, La/a/b/b/a/f;

    invoke-direct {p1, p0}, La/a/b/b/a/f;-><init>(Landroid/support/v4/media/session/MediaSessionCompat$c;)V

    .line 4
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->i:Landroid/media/RemoteControlClient;
...
.method public b(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    .line 2
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->h:Landroid/media/AudioManager;
...
.method public c(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 6
    :cond_1
    iget-object v3, p0, Landroid/support/v4/media/session/MediaSessionCompat$g;->i:Landroid/media/RemoteControlClient;
