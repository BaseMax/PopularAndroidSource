...
.method public getAsList()Ljava/util/List;
    ...
    :goto_0
    :try_start_0
    invoke-virtual {p0}, Lcom/apptentive/android/sdk/module/engagement/interaction/model/common/Actions;->length()I
    ...
    .line 32
    invoke-virtual {p0, v2}, Lcom/apptentive/android/sdk/module/engagement/interaction/model/common/Actions;->getJSONObject(I)Lorg/json/JSONObject;
