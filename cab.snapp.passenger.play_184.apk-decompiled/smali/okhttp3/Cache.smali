...
.method public static key(Lokhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lb/f;->encodeUtf8(Ljava/lang/String;)Lb/f;

    move-result-object p0

    invoke-virtual {p0}, Lb/f;->md5()Lb/f;
...
.method static readInt(Lb/e;)I
    ...
    .line 726
    :try_start_0
    invoke-interface {p0}, Lb/e;->readDecimalLong()J

    move-result-wide v0

    .line 727
    invoke-interface {p0}, Lb/e;->readUtf8LineStrict()Ljava/lang/String;
...
.method final get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v0, v3}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lb/v;

    move-result-object v3

    invoke-direct {v2, v3}, Lokhttp3/Cache$Entry;-><init>(Lb/v;)V
    :try_end_1
