...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    invoke-virtual {p1}, Lb/f;->base64()Ljava/lang/String;
...
.method public final connect(Lokhttp3/OkHttpClient;)V
    ...
    invoke-interface {p1}, Lokhttp3/Call;->timeout()Lb/w;

    move-result-object p1

    invoke-virtual {p1}, Lb/w;->clearTimeout()Lb/w;
...
.method public final initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Lb/d;
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Lb/e;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLb/e;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public final onReadMessage(Lb/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public final declared-synchronized onReadPing(Lb/f;)V
    .locals 1
...
.method public final declared-synchronized onReadPong(Lb/f;)V
    .locals 0
...
.method final declared-synchronized pong(Lb/f;)Z
    .locals 1
...
.method public final send(Lb/f;)Z
    .locals 1
...
.method final writeOneFrame()Z
    ...
    .line 498
    invoke-virtual {v0, v2, v4, v5}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lb/u;
    ...
    .line 500
    invoke-interface {v0, v1}, Lb/d;->write(Lb/f;)Lb/d;
    ...
    iget-object v4, v4, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Lb/f;

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILb/f;)V
...
.method final writePingFrame()V
    ...
    :cond_2
    :try_start_1
    sget-object v1, Lb/f;->EMPTY:Lb/f;
