...
.field static b:Lcom/google/android/gms/internal/on;
...
.method public static onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p0}, Lcom/google/android/gms/internal/bw;->zzbo(Landroid/content/Context;)Z
    ...
    sget-object v2, Lcom/google/android/gms/internal/bv;->a:Ljava/lang/Object;
    ...
    :cond_1
    :try_start_1
    sget-object p1, Lcom/google/android/gms/internal/bv;->b:Lcom/google/android/gms/internal/on;

    if-nez p1, :cond_2

    new-instance p1, Lcom/google/android/gms/internal/on;

    const/4 v1, 0x1

    const-string v3, "Analytics WakeLock"

    invoke-direct {p1, p0, v1, v3}, Lcom/google/android/gms/internal/on;-><init>(Landroid/content/Context;ILjava/lang/String;)V

    sput-object p1, Lcom/google/android/gms/internal/bv;->b:Lcom/google/android/gms/internal/on;

    const/4 p0, 0x0

    invoke-virtual {p1, p0}, Lcom/google/android/gms/internal/on;->setReferenceCounted(Z)V

    :cond_2
    sget-object p0, Lcom/google/android/gms/internal/bv;->b:Lcom/google/android/gms/internal/on;

    const-wide/16 v3, 0x3e8

    invoke-virtual {p0, v3, v4}, Lcom/google/android/gms/internal/on;->acquire(J)V
    :try_end_1
...
.method public static zzbk(Landroid/content/Context;)Z
    ...
    sget-object v0, Lcom/google/android/gms/internal/bv;->c:Ljava/lang/Boolean;
    ...
    sput-object v0, Lcom/google/android/gms/internal/bv;->c:Ljava/lang/Boolean;
