...
.method public static addCookies(Ljava/util/Map;Lcom/koushikdutta/async/http/n;)V
    .locals 3
    ...
    invoke-virtual {p1, v1, v0}, Lcom/koushikdutta/async/http/n;->addAll(Ljava/lang/String;Ljava/util/List;)Lcom/koushikdutta/async/http/n;
...
.method public onHeadersReceived(Lcom/koushikdutta/async/http/b$d;)V
    .locals 1
    ...
    .line 105
    :try_start_0
    iget-object v0, p1, Lcom/koushikdutta/async/http/b$d;->request:Lcom/koushikdutta/async/http/d;
    ...
    iget-object p1, p1, Lcom/koushikdutta/async/http/b$d;->response:Lcom/koushikdutta/async/http/b$h;

    invoke-interface {p1}, Lcom/koushikdutta/async/http/b$h;->headers()Lcom/koushikdutta/async/http/n;

    move-result-object p1

    invoke-virtual {p0, v0, p1}, Lcom/koushikdutta/ion/cookie/CookieMiddleware;->put(Ljava/net/URI;Lcom/koushikdutta/async/http/n;)V
    :try_end_0
...
.method public onRequest(Lcom/koushikdutta/async/http/b$e;)V
    .locals 3
    ...
    iget-object v1, p1, Lcom/koushikdutta/async/http/b$e;->request:Lcom/koushikdutta/async/http/d;
    ...
    iget-object v2, p1, Lcom/koushikdutta/async/http/b$e;->request:Lcom/koushikdutta/async/http/d;
    ...
    .line 95
    iget-object p1, p1, Lcom/koushikdutta/async/http/b$e;->request:Lcom/koushikdutta/async/http/d;

    invoke-virtual {p1}, Lcom/koushikdutta/async/http/d;->getHeaders()Lcom/koushikdutta/async/http/n;

    move-result-object p1

    invoke-static {v0, p1}, Lcom/koushikdutta/ion/cookie/CookieMiddleware;->addCookies(Ljava/util/Map;Lcom/koushikdutta/async/http/n;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public put(Ljava/net/URI;Lcom/koushikdutta/async/http/n;)V
    .locals 5
    ...
    invoke-virtual {p2}, Lcom/koushikdutta/async/http/n;->getMultiMap()Lcom/koushikdutta/async/http/s;
    ...
    invoke-direct {v1}, Lcom/koushikdutta/async/http/n;-><init>()V
    ...
    invoke-virtual {v1, v0, v2}, Lcom/koushikdutta/async/http/n;->add(Ljava/lang/String;Ljava/lang/String;)Lcom/koushikdutta/async/http/n;
...
.method public reinit()V
    ...
    .line 54
    new-instance v5, Lcom/koushikdutta/async/http/n;

    invoke-direct {v5}, Lcom/koushikdutta/async/http/n;-><init>()V
    ...
    .line 62
    invoke-virtual {v5, v9}, Lcom/koushikdutta/async/http/n;->addLine(Ljava/lang/String;)Lcom/koushikdutta/async/http/n;
    ...
    invoke-virtual {v5}, Lcom/koushikdutta/async/http/n;->getMultiMap()Lcom/koushikdutta/async/http/s;
