...
.method private constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$b;)V
    ...
    .line 518
    iput-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat;->b:Landroid/support/v4/media/session/MediaSessionCompat$b;
    ...
    .line 520
    invoke-interface {p2}, Landroid/support/v4/media/session/MediaSessionCompat$b;->getMediaSession()Ljava/lang/Object;

    move-result-object p2

    invoke-static {p2}, Landroid/support/v4/media/session/f;->hasCallback(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p2}, Landroid/support/v4/media/session/MediaSessionCompat;->setCallback(Landroid/support/v4/media/session/MediaSessionCompat$a;)V
...
.method static a(Landroid/support/v4/media/session/PlaybackStateCompat;Landroid/support/v4/media/MediaMetadataCompat;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-virtual/range {v7 .. v13}, Landroid/support/v4/media/session/PlaybackStateCompat$a;->setState(IJFJ)Landroid/support/v4/media/session/PlaybackStateCompat$a;

    move-result-object p0

    .line 961
    invoke-virtual {p0}, Landroid/support/v4/media/session/PlaybackStateCompat$a;->build()Landroid/support/v4/media/session/PlaybackStateCompat;
...
# virtual methods
.method public addOnActiveChangeListener(Landroid/support/v4/media/session/MediaSessionCompat$h;)V
    .locals 1
...
.method public removeOnActiveChangeListener(Landroid/support/v4/media/session/MediaSessionCompat$h;)V
    .locals 1
...
.method public setActive(Z)V
    ...
    .line 644
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$h;->onActiveChanged()V
...
.method public setCallback(Landroid/support/v4/media/session/MediaSessionCompat$a;)V
    .locals 1

    const/4 v0, 0x0

    .line 535
    invoke-virtual {p0, p1, v0}, Landroid/support/v4/media/session/MediaSessionCompat;->setCallback(Landroid/support/v4/media/session/MediaSessionCompat$a;Landroid/os/Handler;)V
...
.method public setCallback(Landroid/support/v4/media/session/MediaSessionCompat$a;Landroid/os/Handler;)V
    ...
    :goto_0
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$b;->setCallback(Landroid/support/v4/media/session/MediaSessionCompat$a;Landroid/os/Handler;)V
