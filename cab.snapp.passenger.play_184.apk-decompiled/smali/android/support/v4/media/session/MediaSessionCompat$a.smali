...
.method public constructor <init>()V
    ...
    invoke-static {v0}, Landroid/support/v4/media/session/i;->createCallback(Landroid/support/v4/media/session/i$a;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Landroid/support/v4/media/session/h;->createCallback(Landroid/support/v4/media/session/h$a;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Landroid/support/v4/media/session/f;->createCallback(Landroid/support/v4/media/session/f$a;)Ljava/lang/Object;
...
.method public onMediaButtonEvent(Landroid/content/Intent;)Z
    ...
    .line 1065
    invoke-virtual {p0, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a;->a(Landroidx/media/MediaSessionManager$RemoteUserInfo;)V
    ...
    invoke-virtual {p1, v3}, Landroid/support/v4/media/session/MediaSessionCompat$a$a;->removeMessages(I)V

    .line 1047
    iput-boolean v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$a;->d:Z

    .line 1048
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->getPlaybackState()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-virtual {p1, v3, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a$a;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    .line 1056
    invoke-virtual {p1, v0, v1, v2}, Landroid/support/v4/media/session/MediaSessionCompat$a$a;->sendMessageDelayed(Landroid/os/Message;J)Z
