...
.method public static getMediaController(Landroid/app/Activity;)Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    .line 198
    invoke-static {p0}, Landroid/support/v4/media/session/c;->getMediaController(Landroid/app/Activity;)Ljava/lang/Object;
    ...
    .line 202
    :cond_2
    invoke-static {v0}, Landroid/support/v4/media/session/c;->getSessionToken(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static setMediaController(Landroid/app/Activity;Landroid/support/v4/media/session/MediaControllerCompat;)V
    ...
    .line 175
    invoke-static {p0, p1}, Landroid/support/v4/media/session/c;->fromToken(Landroid/content/Context;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    .line 177
    :cond_1
    invoke-static {p0, v0}, Landroid/support/v4/media/session/c;->setMediaController(Landroid/app/Activity;Ljava/lang/Object;)V
...
.method public final addQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->addQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;)V
...
.method public final addQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$c;->addQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;I)V
...
.method public final adjustVolume(II)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$c;->adjustVolume(II)V
...
.method public final dispatchMediaButtonEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->dispatchMediaButtonEvent(Landroid/view/KeyEvent;)Z
...
.method public final getFlags()J
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->getFlags()J
...
.method public final getMediaController()Ljava/lang/Object;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->getMediaController()Ljava/lang/Object;
...
.method public final getPlaybackInfo()Landroid/support/v4/media/session/MediaControllerCompat$g;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->getPlaybackInfo()Landroid/support/v4/media/session/MediaControllerCompat$g;
...
.method public final getQueue()Ljava/util/List;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->getQueue()Ljava/util/List;
...
.method public final getQueueTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->getQueueTitle()Ljava/lang/CharSequence;
...
.method public final getRatingType()I
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->getRatingType()I
...
.method public final getSessionActivity()Landroid/app/PendingIntent;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->getSessionActivity()Landroid/app/PendingIntent;
...
.method public final getShuffleMode()I
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->getShuffleMode()I
...
.method public final getTransportControls()Landroid/support/v4/media/session/MediaControllerCompat$h;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->getTransportControls()Landroid/support/v4/media/session/MediaControllerCompat$h;
...
.method public final isCaptioningEnabled()Z
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->isCaptioningEnabled()Z
...
.method public final isSessionReady()Z
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaControllerCompat$c;->isSessionReady()Z
...
.method public final registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    .locals 1

    const/4 v0, 0x0

    .line 585
    invoke-virtual {p0, p1, v0}, Landroid/support/v4/media/session/MediaControllerCompat;->registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
...
.method public final registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$c;->registerCallback(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
...
.method public final removeQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->removeQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;)V
...
.method public final sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/support/v4/media/session/MediaControllerCompat$c;->sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
...
.method public final setVolumeTo(II)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$c;->setVolumeTo(II)V
...
.method public final unregisterCallback(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    ...
    invoke-interface {v1, p1}, Landroid/support/v4/media/session/MediaControllerCompat$c;->unregisterCallback(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    :try_end_0
