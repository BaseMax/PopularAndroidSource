...
public final class a {
    ...
    public final String getIranianDate() {
        return this.f1469a + w.TOPIC_LEVEL_SEPARATOR + this.f1470b + w.TOPIC_LEVEL_SEPARATOR + this.c;
    }
    ...
    private void a() {
        ...
        } while (this.f1469a >= i2);
        int i7 = this.f1469a - i4;
