...
public class SmappDestinationLogRequest extends d {
    @c("action")
    ...
    public String toString() {
        return "SnappPassengerSmappDestinationLogRequest{action=" + this.action + ", uuid='" + this.uuid + '\'' + ", location=" + this.location + '}';
    }
}
