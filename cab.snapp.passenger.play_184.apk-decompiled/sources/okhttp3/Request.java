    ...
    public static class Builder {
        ...
        public Builder cacheControl(CacheControl cacheControl) {
            ...
            if (cacheControl2.isEmpty()) {
                return removeHeader(c.HEADER_CACHE_CONTROL);
            }
            return header(c.HEADER_CACHE_CONTROL, cacheControl2);
        }
        ...
        public Builder head() {
            return method(c.METHOD_HEAD, null);
        }

        public Builder post(RequestBody requestBody) {
            return method(c.METHOD_POST, requestBody);
        }
        ...
        public Builder put(RequestBody requestBody) {
            return method(c.METHOD_PUT, requestBody);
        }
