...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        /* access modifiers changed from: package-private */
        public final Builder parse(@Nullable HttpUrl httpUrl, String str) {
            int delimiterOffset;
            int i;
    ...
    static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) {
        ...
        while (i4 < i3) {
            ...
            canonicalize(cVar, str, i4, i2, str2, z, z2, z3, z4, charset);
            return cVar.readUtf8();
        }
        int i6 = i;
        return str.substring(i, i2);
        ...
        while (i < i2) {
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    cVar.writeUtf8(z ? w.SINGLE_LEVEL_WILDCARD : "%2B");
