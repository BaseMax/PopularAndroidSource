...
class JdkWithJettyBootPlatform extends Platform {
    ...
    public static Platform buildIfSupported() {
        try {
            ...
            JdkWithJettyBootPlatform jdkWithJettyBootPlatform = new JdkWithJettyBootPlatform(method2, cls.getMethod("get", new Class[]{SSLSocket.class}), cls.getMethod(b.ACTION_REMOVE, new Class[]{SSLSocket.class}), cls3, cls4);
