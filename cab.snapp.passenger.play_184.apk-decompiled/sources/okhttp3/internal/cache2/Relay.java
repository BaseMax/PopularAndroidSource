...
final class Relay {
    ...
    static final f PREFIX_CLEAN = f.encodeUtf8("OkHttp cache v1\n");
    static final f PREFIX_DIRTY = f.encodeUtf8("OkHttp DIRTY :(\n");
    ...
    class RelaySource implements v {
        ...
        public long read(b.c r22, long r23) throws java.io.IOException {
            /*
                r21 = this;
                r1 = r21
                r2 = r23
            ...
            L_0x0020:
                ...
                b.w r0 = r1.timeout     // Catch:{ all -> 0x0137 }
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
            ...
            L_0x0039:
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
                b.c r5 = r5.buffer     // Catch:{ all -> 0x0137 }
            ...
            L_0x0094:
                ...
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                b.c r13 = r0.upstreamBuffer     // Catch:{ all -> 0x0109 }
                r15 = 0
                r14 = r22
                r17 = r2
                r13.copyTo((b.c) r14, (long) r15, (long) r17)     // Catch:{ all -> 0x0109 }
                ...
                long r16 = r7 + r11
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                b.c r0 = r0.upstreamBuffer     // Catch:{ all -> 0x0109 }
                b.c r18 = r0.clone()     // Catch:{ all -> 0x0109 }
                r19 = r5
                ...
                b.c r0 = r0.buffer     // Catch:{ all -> 0x0106 }
                okhttp3.internal.cache2.Relay r8 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0106 }
                b.c r8 = r8.upstreamBuffer     // Catch:{ all -> 0x0106 }
                r0.write((b.c) r8, (long) r5)     // Catch:{ all -> 0x0106 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0106 }
                b.c r0 = r0.buffer     // Catch:{ all -> 0x0106 }
                ...
                b.c r0 = r0.buffer     // Catch:{ all -> 0x0106 }
                okhttp3.internal.cache2.Relay r8 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0106 }
                b.c r8 = r8.buffer     // Catch:{ all -> 0x0106 }
            ...
            L_0x011b:
                ...
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
                b.c r9 = r0.buffer     // Catch:{ all -> 0x0137 }
                long r7 = r1.sourcePos     // Catch:{ all -> 0x0137 }
                long r11 = r7 - r5
                r10 = r22
                r13 = r2
                r9.copyTo((b.c) r10, (long) r11, (long) r13)     // Catch:{ all -> 0x0137 }
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0137 }
                long r5 = r5 + r2
            ...
            L_0x0143:
                goto L_0x0142
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.cache2.Relay.RelaySource.read(b.c, long):long");
        }
    ...
    public static Relay edit(File file2, v vVar, f fVar, long j) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file2, "rw");
        Relay relay = new Relay(randomAccessFile, vVar, 0, fVar, j);
    ...
    public static Relay read(File file2) throws IOException {
        ...
        if (cVar.readByteString((long) PREFIX_CLEAN.size()).equals(PREFIX_CLEAN)) {
            long readLong = cVar.readLong();
            long readLong2 = cVar.readLong();
            c cVar2 = new c();
            fileOperator.read(readLong + 32, cVar2, readLong2);
            Relay relay = new Relay(randomAccessFile, null, readLong, cVar2.readByteString(), 0);
            return relay;
        }
