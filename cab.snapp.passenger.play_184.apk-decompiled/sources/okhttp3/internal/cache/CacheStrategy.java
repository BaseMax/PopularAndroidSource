...
public final class CacheStrategy {
    ...
    public static class Factory {
        ...
        public Factory(long j, Request request2, Response response) {
            ...
            if (response != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (c.HEADER_DATE.equalsIgnoreCase(name)) {
                        this.servedDate = HttpDate.parse(value);
                        this.servedDateString = value;
                    } else if (c.HEADER_EXPIRES.equalsIgnoreCase(name)) {
                        this.expires = HttpDate.parse(value);
                    } else if (c.HEADER_LAST_MODIFIED.equalsIgnoreCase(name)) {
                        this.lastModified = HttpDate.parse(value);
                        this.lastModifiedString = value;
                    } else if (c.HEADER_ETAG.equalsIgnoreCase(name)) {
                        this.etag = value;
        ...
        private static boolean hasConditions(Request request2) {
            return (request2.header("If-Modified-Since") == null && request2.header(c.HEADER_IF_NONE_MATCH) == null) ? false : true;
        }
    }
