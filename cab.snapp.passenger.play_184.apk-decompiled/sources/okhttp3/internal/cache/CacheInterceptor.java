...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        final d buffer = n.buffer(body);
        AnonymousClass1 r2 = new v() {
        ...
        return response.newBuilder().body(new RealResponseBody(response.header(io.fabric.sdk.android.services.network.c.HEADER_CONTENT_TYPE), response.body().contentLength(), n.buffer((v) r2))).build();
    }
    ...
    static boolean isEndToEnd(String str) {
        return !"Connection".equalsIgnoreCase(str) && !"Keep-Alive".equalsIgnoreCase(str) && !"Proxy-Authenticate".equalsIgnoreCase(str) && !io.fabric.sdk.android.services.network.c.HEADER_PROXY_AUTHORIZATION.equalsIgnoreCase(str) && !"TE".equalsIgnoreCase(str) && !"Trailers".equalsIgnoreCase(str) && !"Transfer-Encoding".equalsIgnoreCase(str) && !"Upgrade".equalsIgnoreCase(str);
    }

    static boolean isContentSpecificHeader(String str) {
        return io.fabric.sdk.android.services.network.c.HEADER_CONTENT_LENGTH.equalsIgnoreCase(str) || io.fabric.sdk.android.services.network.c.HEADER_CONTENT_ENCODING.equalsIgnoreCase(str) || io.fabric.sdk.android.services.network.c.HEADER_CONTENT_TYPE.equalsIgnoreCase(str);
    }
}
