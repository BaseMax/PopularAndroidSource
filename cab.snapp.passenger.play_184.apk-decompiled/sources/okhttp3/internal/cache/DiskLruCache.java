...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        /* JADX WARNING: Code restructure failed: missing block: B:20:?, code lost:
            ...
            r5.this$0.journalWriter = b.n.buffer(b.n.blackhole());
         */
        ...
        public void run() {
            ...
            L_0x0033:
                ...
                okhttp3.internal.cache.DiskLruCache r1 = okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0045 }
                b.u r2 = b.n.blackhole()     // Catch:{ all -> 0x0045 }
                b.d r2 = b.n.buffer((b.u) r2)     // Catch:{ all -> 0x0045 }
    ...
    public final class Snapshot implements Closeable {
        ...
        Snapshot(String str, long j, v[] vVarArr, long[] jArr) {
            this.key = str;
        ...
        public final v getSource(int i) {
    ...
    public final class Editor {
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public final b.v newSource(int r5) {
            /*
                r4 = this;
                okhttp3.internal.cache.DiskLruCache r0 = okhttp3.internal.cache.DiskLruCache.this
                monitor-enter(r0)
            ...
            L_0x0015:
                ...
                b.v r5 = r1.source(r5)     // Catch:{ FileNotFoundException -> 0x0025 }
            ...
            L_0x002f:
                ...
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.cache.DiskLruCache.Editor.newSource(int):b.v");
        }

        public final u newSink(int i) {
            synchronized (DiskLruCache.this) {
                if (this.done) {
                    throw new IllegalStateException();
                } else if (this.entry.currentEditor != this) {
                    u blackhole = n.blackhole();
                    return blackhole;
                } else {
    ...
    final class Entry {
        ...
        public final void writeLengths(d dVar) throws IOException {
            for (long writeDecimalLong : this.lengths) {
                dVar.writeByte(32).writeDecimalLong(writeDecimalLong);
            }
        }
            ...
            if (Thread.holdsLock(DiskLruCache.this)) {
                ...
                while (i2 < DiskLruCache.this.valueCount) {
                    try {
                        ...
                        while (i < DiskLruCache.this.valueCount && vVarArr[i] != null) {
                            Util.closeQuietly((Closeable) vVarArr[i]);
                            i++;
                        }
                        try {
                ...
                Snapshot snapshot = new Snapshot(this.key, this.sequenceNumber, vVarArr, jArr);
                return snapshot;
            }
    ...
    private void readJournal() throws java.io.IOException {
        /*
            ...
            b.v r1 = r1.source(r2)
            b.e r1 = b.n.buffer((b.v) r1)
            java.lang.String r2 = r1.readUtf8LineStrict()     // Catch:{ all -> 0x00a5 }
            java.lang.String r3 = r1.readUtf8LineStrict()     // Catch:{ all -> 0x00a5 }
            java.lang.String r4 = r1.readUtf8LineStrict()     // Catch:{ all -> 0x00a5 }
            java.lang.String r5 = r1.readUtf8LineStrict()     // Catch:{ all -> 0x00a5 }
            java.lang.String r6 = r1.readUtf8LineStrict()     // Catch:{ all -> 0x00a5 }
        ...
        L_0x005d:
            ...
            boolean r0 = r1.exhausted()     // Catch:{ all -> 0x00a5 }
            if (r0 != 0) goto L_0x0070
            r9.rebuildJournal()     // Catch:{ all -> 0x00a5 }
            goto L_0x0076
        L_0x0070:
            b.d r0 = r9.newJournalWriter()     // Catch:{ all -> 0x00a5 }
    ...
    private d newJournalWriter() throws FileNotFoundException {
        return n.buffer((u) new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) {
            static final /* synthetic */ boolean $assertionsDisabled = false;
    ...
    public final synchronized void rebuildJournal() throws IOException {
        ...
        d buffer = n.buffer(this.fileSystem.sink(this.journalFileTmp));
        try {
    ...
    public final synchronized okhttp3.internal.cache.DiskLruCache.Snapshot get(java.lang.String r4) throws java.io.IOException {
        ...
        L_0x0022:
            ...
            b.d r1 = r3.journalWriter     // Catch:{ all -> 0x0050 }
            java.lang.String r2 = "READ"
            b.d r1 = r1.writeUtf8(r2)     // Catch:{ all -> 0x0050 }
            r2 = 32
            b.d r1 = r1.writeByte(r2)     // Catch:{ all -> 0x0050 }
            b.d r4 = r1.writeUtf8(r4)     // Catch:{ all -> 0x0050 }
            r1 = 10
    ...
    public final synchronized okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r6, long r7) throws java.io.IOException {
        ...
        L_0x002b:
            ...
            goto L_0x006b
        L_0x0034:
            b.d r7 = r5.journalWriter     // Catch:{ all -> 0x0074 }
            java.lang.String r8 = "DIRTY"
            b.d r7 = r7.writeUtf8(r8)     // Catch:{ all -> 0x0074 }
            r8 = 32
            b.d r7 = r7.writeByte(r8)     // Catch:{ all -> 0x0074 }
            b.d r7 = r7.writeUtf8(r6)     // Catch:{ all -> 0x0074 }
            r8 = 10
    ...
    public final synchronized void completeEdit(okhttp3.internal.cache.DiskLruCache.Editor r10, boolean r11) throws java.io.IOException {
        ...
        L_0x0078:
            ...
            b.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            java.lang.String r1 = "CLEAN"
            b.d r10 = r10.writeUtf8(r1)     // Catch:{ all -> 0x00f4 }
            r10.writeByte(r3)     // Catch:{ all -> 0x00f4 }
            b.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            java.lang.String r1 = r0.key     // Catch:{ all -> 0x00f4 }
            r10.writeUtf8(r1)     // Catch:{ all -> 0x00f4 }
            b.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            r0.writeLengths(r10)     // Catch:{ all -> 0x00f4 }
            b.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            r10.writeByte(r2)     // Catch:{ all -> 0x00f4 }
        ...
        L_0x00b4:
            ...
            b.d r10 = r10.writeUtf8(r11)     // Catch:{ all -> 0x00f4 }
            r10.writeByte(r3)     // Catch:{ all -> 0x00f4 }
            b.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x00f4 }
            r10.writeUtf8(r11)     // Catch:{ all -> 0x00f4 }
            b.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
            r10.writeByte(r2)     // Catch:{ all -> 0x00f4 }
        L_0x00d2:
            b.d r10 = r9.journalWriter     // Catch:{ all -> 0x00f4 }
