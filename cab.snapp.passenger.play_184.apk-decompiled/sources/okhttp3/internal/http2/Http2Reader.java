...
final class Http2Reader implements Closeable {
    ...
    static final class ContinuationSource implements v {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            byte readByte = (byte) (this.source.readByte() & com.pusher.java_websocket.drafts.c.END_OF_FRAME);
            this.flags = (byte) (this.source.readByte() & com.pusher.java_websocket.drafts.c.END_OF_FRAME);
    ...
    public final void readConnectionPreface(Handler handler) throws IOException {
        if (!this.client) {
            f readByteString = this.source.readByteString((long) Http2.CONNECTION_PREFACE.size());
    ...
    public final boolean nextFrame(boolean z, Handler handler) throws IOException {
        try {
            ...
            byte readByte = (byte) (this.source.readByte() & com.pusher.java_websocket.drafts.c.END_OF_FRAME);
            if (!z || readByte == 4) {
                byte readByte2 = (byte) (this.source.readByte() & com.pusher.java_websocket.drafts.c.END_OF_FRAME);
    ...
    private void readHeaders(Handler handler, int i, byte b2, int i2) throws IOException {
        ...
        if (i2 != 0) {
            boolean z = (b2 & 1) != 0;
            if ((b2 & 8) != 0) {
                s = (short) (this.source.readByte() & com.pusher.java_websocket.drafts.c.END_OF_FRAME);
            }
            if ((b2 & 32) != 0) {
    ...
    private void readPriority(Handler handler, int i) throws IOException {
        ...
        handler.priority(i, readInt & ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, (this.source.readByte() & com.pusher.java_websocket.drafts.c.END_OF_FRAME) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
    ...
    private void readPushPromise(Handler handler, int i, byte b2, int i2) throws IOException {
        ...
        if (i2 != 0) {
            ...
            handler.pushPromise(i2, this.source.readInt() & ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, readHeaderBlock(lengthWithoutPadding(i - 4, b2, s), s, b2, i2));
            return;
        }
    ...
    private void readGoAway(Handler handler, int i, byte b2, int i2) throws IOException {
        if (i < 8) {
            ...
            if (fromHttp2 != null) {
                f fVar = f.EMPTY;
                if (i3 > 0) {
                    fVar = this.source.readByteString((long) i3);
                }
    ...
    static int readMedium(e eVar) throws IOException {
        return (eVar.readByte() & com.pusher.java_websocket.drafts.c.END_OF_FRAME) | ((eVar.readByte() & com.pusher.java_websocket.drafts.c.END_OF_FRAME) << 16) | ((eVar.readByte() & com.pusher.java_websocket.drafts.c.END_OF_FRAME) << 8);
    }
