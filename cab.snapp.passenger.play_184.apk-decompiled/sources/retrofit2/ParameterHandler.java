...
abstract class ParameterHandler<T> {
    ...
    static final class FieldMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        /* access modifiers changed from: package-private */
        public final void apply(RequestBuilder requestBuilder, @Nullable Map<String, T> map) throws IOException {
            if (map != null) {
            ...
            if (map != null) {
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (str != null) {
                        Object value = next.getValue();
                        if (value != null) {
                            requestBuilder.addPart(Headers.of(g.CONTENT_DISPOSITION, "form-data; name=\"" + str + "\"", "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
                        } else {
