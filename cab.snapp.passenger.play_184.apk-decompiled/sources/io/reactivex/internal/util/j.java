...
public final class j<T> implements c<List<T>, List<T>, List<T>> {

    /* renamed from: a  reason: collision with root package name */
    final Comparator<? super T> f8643a;

    public j(Comparator<? super T> comparator) {
        this.f8643a = comparator;
    }
    ...
    public final java.util.List<T> apply(java.util.List<T> r6, java.util.List<T> r7) throws java.lang.Exception {
        ...
        L_0x0037:
            ...
            java.util.Comparator<? super T> r4 = r5.f8643a
