...
public final class ba<T, R> extends a<T, R> {
    ...
    static final class a<T, R> extends AtomicInteger implements ag<T>, c {
        ...
        final h<? super T, ? extends ao<? extends R>> f;
        final AtomicReference<io.reactivex.internal.d.c<R>> g = new AtomicReference<>();
        c h;
        volatile boolean i;

        /* renamed from: io.reactivex.internal.operators.c.ba$a$a  reason: collision with other inner class name */
        final class C0161a extends AtomicReference<c> implements al<R>, c {
            C0161a() {
            }
            ...
            public final void onSuccess(R r5) {
                /*
                    r4 = this;
                    io.reactivex.internal.operators.c.ba$a r0 = io.reactivex.internal.operators.c.ba.a.this
                    ...
                    io.reactivex.ag<? super R> r3 = r0.f7176a
                    r3.onNext(r5)
                ...
                L_0x0036:
                    ...
                    io.reactivex.ag<? super R> r0 = r0.f7176a
                    r0.onError(r5)
                    return
                L_0x0044:
                    io.reactivex.ag<? super R> r5 = r0.f7176a
                    r5.onComplete()
                    return
                L_0x004a:
                ...
                L_0x0086:
                    goto L_0x0085
                */
                throw new UnsupportedOperationException("Method not decompiled: io.reactivex.internal.operators.c.ba.a.C0161a.onSuccess(java.lang.Object):void");
            }
        ...
        public final void onNext(T t) {
            try {
                ao aoVar = (ao) io.reactivex.internal.a.b.requireNonNull(this.f.apply(t), "The mapper returned a null SingleSource");
    ...
    public ba(ae<T> aeVar, h<? super T, ? extends ao<? extends R>> hVar, boolean z) {
        super(aeVar);
        this.f7175b = hVar;
        this.c = z;
    }
    ...
    public final void subscribeActual(ag<? super R> agVar) {
        this.f7091a.subscribe(new a(agVar, this.f7175b, this.c));
    }
}
