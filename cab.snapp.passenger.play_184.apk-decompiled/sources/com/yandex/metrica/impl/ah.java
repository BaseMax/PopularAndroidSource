...
public class ah {
    ...
    public static final long f5678a = TimeUnit.SECONDS.toMillis(10);
    ...
    private final ServiceConnection g = new ServiceConnection() {
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            IMetricaService unused = ah.this.e = IMetricaService.Stub.asInterface(iBinder);
            ah.b(ah.this);
        }

        public void onServiceDisconnected(ComponentName componentName) {
            IMetricaService unused = ah.this.e = null;
            ah.this.g();
        }
    };
    ...
    public synchronized void a() {
        if (this.e == null) {
            try {
                this.f5679b.bindService(bo.b(this.f5679b), this.g, 1);
    ...
    public void b() {
        ...
        this.c.postDelayed(this.f, f5678a);
    }
    ...
    public synchronized void f() {
        /*
            r3 = this;
            monitor-enter(r3)
            android.content.Context r0 = r3.f5679b     // Catch:{ all -> 0x001c }
            r1 = 0
            if (r0 == 0) goto L_0x0015
            boolean r0 = r3.d()     // Catch:{ all -> 0x001c }
            if (r0 == 0) goto L_0x0015
            android.content.Context r0 = r3.f5679b     // Catch:{ Exception -> 0x0015 }
        ...
        L_0x001c:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yandex.metrica.impl.ah.f():void");
    }
