...
public final class h {
    ...
    public static final class b {
        ...
        public final int getTotalECCodewords() {
            return this.f4423a * getNumBlocks();
        }

        public final a[] getECBlocks() {
            return this.f4424b;
        }
    }
    ...
    private h(int i, int[] iArr, b... bVarArr) {
        ...
        for (a aVar : bVarArr[0].getECBlocks()) {
            i2 += aVar.getCount() * (aVar.getDataCodewords() + eCCodewordsPerBlock);
        }
        this.f = i2;
    }
    ...
    public final int getDimensionForVersion() {
        return (this.f4419a * 4) + 17;
    }

    public final b getECBlocksForLevel(ErrorCorrectionLevel errorCorrectionLevel) {
        return this.e[errorCorrectionLevel.ordinal()];
    }

    public static h getProvisionalVersionForDimension(int i) throws d {
        if (i % 4 == 1) {
            try {
    ...
    public static h getVersionForNumber(int i) {
        if (i > 0 && i <= 40) {
            return d[i - 1];
        }
