...
public final class sv {
    ...
    protected static final Charset f3526a = Charset.forName("UTF-8");

    /* renamed from: b  reason: collision with root package name */
    private static Charset f3527b = Charset.forName("ISO-8859-1");
    ...
    public static void zza(sr srVar, sr srVar2) {
        if (srVar.f3519a != null) {
            srVar2.f3519a = (st) srVar.f3519a.clone();
        }
    }
