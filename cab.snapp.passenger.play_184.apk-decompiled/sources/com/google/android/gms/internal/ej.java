...
public final class ej {
    private static void a(Parcel parcel, int i, int i2) {
        ...
        if (zza != i2) {
            ...
            sb.append(hexString);
            sb.append(")");
            throw new ek(sb.toString(), parcel);
        }
    }
    ...
    public static int zzd(Parcel parcel) {
        ...
        if ((65535 & readInt) != 20293) {
            ...
            throw new ek(valueOf.length() != 0 ? "Expected object header. Got 0x".concat(valueOf) : new String("Expected object header. Got 0x"), parcel);
        }
