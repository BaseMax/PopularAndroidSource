...
public enum zzaxb {
    ...
    public static boolean zza(zzaxb zzaxb) {
        return BAD_AUTHENTICATION.equals(zzaxb) || CAPTCHA.equals(zzaxb) || NEED_PERMISSION.equals(zzaxb) || NEED_REMOTE_CONSENT.equals(zzaxb) || NEEDS_BROWSER.equals(zzaxb) || USER_CANCEL.equals(zzaxb) || DEVICE_MANAGEMENT_REQUIRED.equals(zzaxb) || DM_INTERNAL_ERROR.equals(zzaxb) || DM_SYNC_DISABLED.equals(zzaxb) || DM_ADMIN_BLOCKED.equals(zzaxb) || DM_ADMIN_PENDING_APPROVAL.equals(zzaxb) || DM_STALE_SYNC_REQUIRED.equals(zzaxb) || DM_DEACTIVATED.equals(zzaxb) || DM_REQUIRED.equals(zzaxb) || THIRD_PARTY_DEVICE_MANAGEMENT_REQUIRED.equals(zzaxb) || DM_SCREENLOCK_REQUIRED.equals(zzaxb);
    }

    public static final zzaxb zzfb(String str) {
        zzaxb zzaxb = null;
        for (zzaxb zzaxb2 : values()) {
            if (zzaxb2.Y.equals(str)) {
                zzaxb = zzaxb2;
            }
        }
        return zzaxb;
