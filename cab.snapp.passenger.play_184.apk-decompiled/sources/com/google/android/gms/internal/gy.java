...
public interface gy extends IInterface {
    ...
    void zza(gt gtVar) throws RemoteException;

    void zza(zzcdz zzcdz) throws RemoteException;

    void zza(zzcfq zzcfq) throws RemoteException;

    void zza(GeofencingRequest geofencingRequest, PendingIntent pendingIntent, gw gwVar) throws RemoteException;

    void zza(LocationSettingsRequest locationSettingsRequest, ha haVar, String str) throws RemoteException;

    void zza(zzag zzag, gw gwVar) throws RemoteException;
