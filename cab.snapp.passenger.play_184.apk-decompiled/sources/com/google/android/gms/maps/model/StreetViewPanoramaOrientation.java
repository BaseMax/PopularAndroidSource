...
public class StreetViewPanoramaOrientation extends zzbfm {
    public static final Parcelable.Creator<StreetViewPanoramaOrientation> CREATOR = new ab();
    ...
    public String toString() {
        return ag.zzx(this).zzg("tilt", Float.valueOf(this.tilt)).zzg("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel parcel, int i) {
        int zze = el.zze(parcel);
        el.zza(parcel, 2, this.tilt);
