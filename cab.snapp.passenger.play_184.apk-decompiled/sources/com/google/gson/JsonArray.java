...
public final class JsonArray extends JsonElement implements Iterable<JsonElement> {
    ...
    public final void add(Boolean bool) {
        this.elements.add(bool == null ? k.INSTANCE : new JsonPrimitive(bool));
    }

    public final void add(Character ch) {
        this.elements.add(ch == null ? k.INSTANCE : new JsonPrimitive(ch));
    }

    public final void add(Number number) {
        this.elements.add(number == null ? k.INSTANCE : new JsonPrimitive(number));
    }

    public final void add(String str) {
        this.elements.add(str == null ? k.INSTANCE : new JsonPrimitive(str));
    }

    public final void add(JsonElement jsonElement) {
        if (jsonElement == null) {
            jsonElement = k.INSTANCE;
        }
