...
final class DexterInstance {
    ...
    private void updatePermissionsAsDenied(Collection<String> collection) {
        for (String next : collection) {
            this.multiplePermissionsReport.addDeniedPermissionResponse(PermissionDeniedResponse.from(next, !this.androidPermissionService.shouldShowRequestPermissionRationale(this.activity, next)));
        }
    ...
    public final void checkPermission(PermissionListener permissionListener, String str, Thread thread) {
        checkSinglePermission(permissionListener, str, thread);
    }

    /* access modifiers changed from: package-private */
    public final void checkPermissions(MultiplePermissionsListener multiplePermissionsListener, Collection<String> collection, Thread thread) {
    ...
    /* access modifiers changed from: package-private */
    public final void onActivityReady(Activity activity2) {
