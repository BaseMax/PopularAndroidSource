...
final class b {
    ...
    public static byte[] decode(String str) {
        ...
        if (i7 == 2) {
            bArr[i3] = (byte) ((b2 << u.MESSAGE_TYPE_PINGREQ) >> 16);
            i3++;
        } else if (i7 == 3) {
            int i8 = b2 << 6;
            int i9 = i3 + 1;
    ...
    private static String a(byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < length; i2 += 3) {
            int i3 = i + 1;
            bArr3[i] = bArr2[(bArr[i2] & c.END_OF_FRAME) >> 2];
            int i4 = i3 + 1;
            int i5 = i2 + 1;
            bArr3[i3] = bArr2[((bArr[i2] & 3) << 4) | ((bArr[i5] & c.END_OF_FRAME) >> 4)];
            int i6 = i4 + 1;
            int i7 = i2 + 2;
            bArr3[i4] = bArr2[((bArr[i5] & 15) << 2) | ((bArr[i7] & c.END_OF_FRAME) >> 6)];
            i = i6 + 1;
        ...
        if (length2 == 1) {
            int i8 = i + 1;
            bArr3[i] = bArr2[(bArr[length] & c.END_OF_FRAME) >> 2];
            int i9 = i8 + 1;
            ...
            int i11 = i10 + 1;
            int i12 = length + 1;
            bArr3[i10] = bArr2[((bArr[i12] & c.END_OF_FRAME) >> 4) | ((bArr[length] & 3) << 4)];
