...
class CircleImageView extends ImageView {
    ...
    class OvalShadow extends OvalShape {
        ...
        private void updateRadialGradient(int i) {
            float f = (float) (i / 2);
            RadialGradient radialGradient = new RadialGradient(f, f, (float) CircleImageView.this.mShadowRadius, new int[]{CircleImageView.FILL_SHADOW_COLOR, 0}, null, Shader.TileMode.CLAMP);
