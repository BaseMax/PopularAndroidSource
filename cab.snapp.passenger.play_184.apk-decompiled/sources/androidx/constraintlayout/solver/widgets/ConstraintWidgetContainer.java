...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    public void layout() {
        ...
        L_0x0131:
            ...
            java.util.ArrayList r8 = r1.mChildren     // Catch:{ Exception -> 0x015e }
            java.lang.Object r8 = r8.get(r0)     // Catch:{ Exception -> 0x015e }
            androidx.constraintlayout.solver.widgets.ConstraintWidget r8 = (androidx.constraintlayout.solver.widgets.ConstraintWidget) r8     // Catch:{ Exception -> 0x015e }
            r18 = r9
            androidx.constraintlayout.solver.LinearSystem r9 = r1.mSystem     // Catch:{ Exception -> 0x015c }
            r8.createObjectVariables(r9)     // Catch:{ Exception -> 0x015c }
            int r0 = r0 + 1
            r9 = r18
            goto L_0x0131
        L_0x0147:
            r18 = r9
            androidx.constraintlayout.solver.LinearSystem r0 = r1.mSystem     // Catch:{ Exception -> 0x015c }
            boolean r8 = r1.addChildrenToSolver(r0)     // Catch:{ Exception -> 0x015c }
            if (r8 == 0) goto L_0x0159
            androidx.constraintlayout.solver.LinearSystem r0 = r1.mSystem     // Catch:{ Exception -> 0x0157 }
            r0.minimize()     // Catch:{ Exception -> 0x0157 }
            goto L_0x0159
        L_0x0157:
            r0 = move-exception
            goto L_0x0163
        ...
        L_0x02ab:
            ...
            r4 = r4[r8]
            androidx.constraintlayout.solver.widgets.ConstraintWidget$DimensionBehaviour r12 = androidx.constraintlayout.solver.widgets.ConstraintWidget.DimensionBehaviour.WRAP_CONTENT
            if (r4 != r12) goto L_0x02c9
            if (r6 <= 0) goto L_0x02c9
            int r4 = r21.getHeight()
            if (r4 <= r6) goto L_0x02c9
