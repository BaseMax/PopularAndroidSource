...
public class NavController {
    ...
    public boolean dispatchOnDestinationChanged() {
        while (!this.mBackStack.isEmpty() && (this.mBackStack.peekLast().getDestination() instanceof NavGraph)) {
            if (!popBackStackInternal(this.mBackStack.peekLast().getDestination().getId(), true)) {
                break;
            }
        }
        if (this.mBackStack.isEmpty()) {
