...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:144:0x02c9  */
    /* JADX WARNING: Removed duplicated region for block: B:260:0x0491  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void moveToState(androidx.fragment.app.Fragment r18, int r19, int r20, int r21, boolean r22) {
        /*
            r17 = this;
            r6 = r17
            r7 = r18
        ...
        L_0x021a:
            ...
            android.content.res.Resources r1 = r18.getResources()     // Catch:{ NotFoundException -> 0x0235 }
            int r2 = r7.mContainerId     // Catch:{ NotFoundException -> 0x0235 }
            java.lang.String r1 = r1.getResourceName(r2)     // Catch:{ NotFoundException -> 0x0235 }
            goto L_0x0237
        L_0x0235:
            ...
            if (size2 > 0) {
                ...
                for (int i = 0; i < size2; i++) {
                    ...
                    if (DEBUG) {
                        ...
                        sb3.append(i);
                        sb3.append(": ");
                        sb3.append(this.mBackStack.get(i));
                    }
                }
            }
        }
        ...
        if (parcelable != null) {
            ...
            if (fragmentManagerState.mActive != null) {
                for (Fragment next : this.mNonConfig.getRetainedFragments()) {
                    if (DEBUG) {
                        new StringBuilder("restoreSaveState: re-attaching retained ").append(next);
                    }
                    ...
                    if (fragmentState == null) {
                        if (DEBUG) {
                            ...
                            sb.append(fragmentManagerState.mActive);
                        }
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void attachController(androidx.fragment.app.FragmentHostCallback r3, androidx.fragment.app.FragmentContainer r4, androidx.fragment.app.Fragment r5) {
        /*
            r2 = this;
    ...
    public final FragmentFactory getFragmentFactory() {
        ...
        while (true) {
            ...
            if (fragment == null) {
                fragmentManagerImpl.setFragmentFactory(new FragmentFactory() {
