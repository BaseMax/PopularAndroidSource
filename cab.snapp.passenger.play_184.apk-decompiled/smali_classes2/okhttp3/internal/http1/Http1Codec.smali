...
.method private readHeaderLine()Ljava/lang/String;
    ...
    invoke-interface {v0, v1, v2}, Lb/e;->readUtf8LineStrict(J)Ljava/lang/String;
...
.method public final createRequestBody(Lokhttp3/Request;J)Lb/u;
    .locals 2
    ...
    .line 100
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSink()Lb/u;
    ...
    .line 105
    invoke-virtual {p0, p2, p3}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSink(J)Lb/u;
...
.method final detachTimeout(Lb/j;)V
    .locals 2

    .line 268
    invoke-virtual {p1}, Lb/j;->delegate()Lb/w;

    move-result-object v0

    .line 269
    sget-object v1, Lb/w;->NONE:Lb/w;

    invoke-virtual {p1, v1}, Lb/j;->setDelegate(Lb/w;)Lb/j;
...
.method public final newChunkedSink()Lb/u;
    .locals 3
...
.method public final newChunkedSource(Lokhttp3/HttpUrl;)Lb/v;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public final newFixedLengthSink(J)Lb/u;
    .locals 2
...
.method public final newFixedLengthSource(J)Lb/v;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public final newUnknownLengthSource()Lb/v;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public final openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    .line 138
    invoke-virtual {p0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lb/v;
    ...
    invoke-direct {v3, v0, v1, v2, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLb/e;)V
    ...
    invoke-virtual {p0, p1}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSource(Lokhttp3/HttpUrl;)Lb/v;
    ...
    invoke-direct {v1, v0, v2, v3, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLb/e;)V
    ...
    .line 149
    invoke-virtual {p0, v4, v5}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lb/v;
    ...
    invoke-direct {v1, v0, v4, v5, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLb/e;)V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newUnknownLengthSource()Lb/v;

    move-result-object v1

    invoke-static {v1}, Lb/n;->buffer(Lb/v;)Lb/e;

    move-result-object v1

    invoke-direct {p1, v0, v2, v3, v1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLb/e;)V
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lb/d;->writeUtf8(Ljava/lang/String;)Lb/d;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lb/d;->writeUtf8(Ljava/lang/String;)Lb/d;
    ...
    .line 174
    iget-object v2, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lb/d;

    invoke-virtual {p1, p2}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v3}, Lb/d;->writeUtf8(Ljava/lang/String;)Lb/d;
    ...
    .line 177
    invoke-interface {v2, v0}, Lb/d;->writeUtf8(Ljava/lang/String;)Lb/d;
    ...
    invoke-interface {p1, v0}, Lb/d;->writeUtf8(Ljava/lang/String;)Lb/d;
