...
.method final snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lb/v;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Lb/v;[J)V
    :try_end_0
...
.method final writeLengths(Lb/d;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1011
    invoke-interface {p1, v5}, Lb/d;->writeByte(I)Lb/d;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lb/d;->writeDecimalLong(J)Lb/d;
