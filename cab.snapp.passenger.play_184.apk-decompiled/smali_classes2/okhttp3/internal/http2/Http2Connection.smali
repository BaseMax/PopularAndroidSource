...
.method constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iget-object v3, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lb/d;

    iget-boolean v4, v0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/Http2Writer;-><init>(Lb/d;Z)V
    ...
    iget-object v1, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lb/e;

    iget-boolean v4, v0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v3, v1, v4}, Lokhttp3/internal/http2/Http2Reader;-><init>(Lb/e;Z)V
...
.method final pushDataLater(ILb/e;IZ)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 890
    invoke-interface {p2, v0, v1}, Lb/e;->require(J)V
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/http2/Http2Connection$5;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILb/c;IZ)V
...
.method public final writeData(IZLb/c;J)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p4, p2, p1, p3, v0}, Lokhttp3/internal/http2/Http2Writer;->data(ZILb/c;I)V
    ...
    :goto_2
    invoke-virtual {v4, v5, p1, p3, v3}, Lokhttp3/internal/http2/Http2Writer;->data(ZILb/c;I)V
